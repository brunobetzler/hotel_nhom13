...
// // ===== API BASE =====
// // Có thể override bằng cách gán window.API_BASE trước khi load file này
// var API_BASE =
//   window.API_BASE ||
//   (function () {
//     var origin = location.origin;

//     // Nếu chạy local (xampp / vite dev)
//     if (/localhost|127\.0\.0\.1/.test(origin)) {
//       // Local thì vẫn trỏ về host thật để test API online
//       // return 'http://localhost:8000/hotel/hotel-api-php/src/controllers/';
//       return "http://localhost:8080/src/controllers/";
//     }

//     // Nếu chạy trên host thật
//     // return origin + '/hotel/hotel-api-php/src/controllers';
//     return origin + "/app/hotel/hotel-api-php/src/controllers";
//   })();
...
//           typeof data === "string"
//             ? data
//             : (data && (data.message || data.error)) || "Request error";
//         throw new Error(msg);
//       }
//       return data;
//     });
...
// var Auth = {
//   me: function () {
//     return api("AuthController.php?action=me");
//   },
//   login: function (username, password) {
//     return api("AuthController.php?action=login", {
//       method: "POST",
//       body: { username: username, password: password },
//     });
//   },
//   logout: function () {
//     return api("AuthController.php?action=logout", { method: "POST" });
//   },
// };
...
//   slot.innerHTML =
//     '<span class="text-sm text-gray-700"><b>' +
//     name +
//     "</b></span>" +
...
// ===== API BASE =====
window.API_BASE = "/api/src/controllers";
var API_BASE = window.API_BASE || "/api/src/controllers";
// ===== FETCH WRAPPER =====
function api(path, opt) {
  opt = opt || {};
  var url = /^https?:\/\//i.test(path) ? path : API_BASE + "/" + path;

  var hasBody = opt.body !== undefined && opt.body !== null;
  var body =
    typeof opt.body === "string"
      ? opt.body
      : hasBody
